...
public:
    ...
    */
	...
	bool CopyFile(int userID, std::string oldFilePath, std::string newFilePath);

	bool MoveFile(int userID, std::string oldFilePath, std::string newFilePath, int startBlock = -1);
